...
class ELECTRIC_FIELD(object):
    ...
    def update_V_relaxation(self):       # use relaxation method solve the potential
...
cmp=ELECTRIC_FIELD(1,0.999999,0,20)
cmp.update_V_relaxation()
...
# give plot of potential and electric field with SOR method
fig=plt.figure(figsize=(10,5))
ax1=plt.axes([0.1,0.1,0.35,0.8])
ax2=plt.axes([0.55,0.1,0.35,0.8])
cmp=ELECTRIC_FIELD(1,0.999999,-1,20)
cmp.update_V_SOR()
cmp.Ele_field(-1,1,-1,1)
cmp.plot_2d(ax1,ax2,-1.,1.,-1.,1.)
plt.show()     
...
# give 3d plot of potential with SOR method
fig=plt.figure(figsize=(14,7))
ax1= plt.subplot(1,1,1,projection='3d')
cmp=ELECTRIC_FIELD(1,0.9999999,-1)
cmp.update_V_SOR()
cmp.plot_3d(ax1,-1.,1.,-1.,1.)
fig.colorbar(cmp.surf, shrink=0.5, aspect=5)
plt.show(fig)
